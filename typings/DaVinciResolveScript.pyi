...
class Resolve:
    ...
    * resolve.AUTO_CAPTION_LINE_DOUBLE
    ...
    def ImportLayoutPreset(
        self, presetFilePath: str, presetName: Optional[str]
    ) -> bool:
        """
...
GalleryStillExportFormat = Literal[
    "dpx", "cin", "tif", "jpg", "png", "ppm", "bmp", "xpm"
]
...
SubTrackType = Literal[
    ...
    "7.1",
    "7.1film",
] + ["adaptive{number}".format(number) for number in range(1, 36)]
...
AudioSyncSettings = TypedDict(
    "AudioSyncSettings",
    {
        Resolve.AUDIO_SYNC_MODE: Literal[
...
AutoCaptionSettings = TypedDict(
    "AutoCaptionSettings",
    {
        Resolve.SUBTITLE_LANGUAGE: Literal[
            Resolve.AUTO_CAPTION_AUTO,
            Resolve.AUTO_CAPTION_DANISH,
            Resolve.AUTO_CAPTION_DUTCH,
            Resolve.AUTO_CAPTION_ENGLISH,
        ...
        Resolve.SUBTITLE_LINE_BREAK: Literal[
            Resolve.AUTO_CAPTION_LINE_SINGLE, Resolve.AUTO_CAPTION_LINE_DOUBLE
        ],
        Resolve.SUBTITLE_GAP: Annotated[int, ValueRange(0, 10)],
    },
)

CloudProjectsSettings = TypedDict(
    "CloudProjectsSettings",
    {
        ...
        Resolve.CLOUD_SETTING_SYNC_MODE: Literal[
            Resolve.CLOUD_SYNC_NONE,
            Resolve.CLOUD_SYNC_PROXY_ONLY,
            Resolve.CLOUD_SYNC_PROXY_AND_ORIG,
        ],
...
class ProjectManager:
    def ArchiveProject(
        ...
        isArchiveProxyMedia: bool = False,
    ) -> bool:
    ...
    def ExportProject(
        self, projectName: str, filePath: str, withStillsAndLUTs: bool = True
    ) -> bool:
    ...
    def ImportCloudProject(
        self, filePath: str, cloudSettings: CloudProjectsSettings
    ) -> bool:
        """
    ...
    def RestoreCloudProject(
        self, folderPath: str, cloudSettings: CloudProjectsSettings
    ) -> bool:
        """
...
class Project:
    ...
    @overload
    def StartRendering(
        self, jobIds: List[str], isInteractiveMode: bool = False
    ) -> bool:
        """
        Starts rendering jobs indicated by the input job ids.
    ...
    def RenderWithQuickExport(
        self, preset_name: str, param_dict: QuickExportRenderSettings
    ) -> QuickExportJobStatus | str:
        """
    ...
    def InsertAudioToCurrentTrackAtPlayhead(
        self, mediaPath: str, startOffsetInSamples: int, durationInSamples: int
    ) -> bool:
        """
...
class MediaStorage:
    ...
    def AddItemListToMediaPool(
        self, itemInfo: List[MediaPoolItemInfo]
    ) -> List[MediaPoolItem]:
        """
...
class MediaPool:
    ...
    def AppendToTimeline(
        self, clip1: MediaPoolItem, *args: MediaPoolItem
    ) -> List[TimelineItem]:
    ...
    def CreateTimelineFromClips(
        self, name: str, clip1: MediaPoolItem, *args: MediaPoolItem
    ) -> Timeline:
    ...
    @overload
    def CreateTimelineFromClips(
        self, name: str, clipInfo: List[MediaPoolClipInfo]
    ) -> Timeline:
    ...
    def ImportTimelineFromFile(
        self, filePath: str, importOptions: TimelineImportOptions
    ) -> Timeline:
        """
    ...
    def CreateStereoClip(
        self, LeftMediaPoolItem: MediaPoolItem, RightMediaPoolItem: MediaPoolItem
    ) -> MediaPoolItem:
    ...
    def AutoSyncAudio(
        self, MediaPoolItems: List[MediaPoolItem], audioSyncSettings: AudioSyncSettings
    ) -> bool:
        """
...
class MediaPoolItem:
    ...
    def SetMarkInOut(
        self, mark_in: int, mark_out: int, type: MarkInOutType = "all"
    ) -> bool:
...
class Timeline:
    ...
    def GetItemListInTrack(
        self, trackType: TrackType, index: int
    ) -> List[TimelineItem]:
    ...
    def CreateCompoundClip(
        self, timelineItems: List[TimelineItem], clipInfo: Optional[TimelineClipInfo]
    ) -> TimelineItem:
        """
    ...
    def ImportIntoTimeline(
        self, filePath: str, importOptions: Optional[TimelineItemsImportOptions]
    ) -> bool:
        """
    ...
    def Export(
        self,
        fileName: str,
        exportType: TimelineExportType,
        exportSubtype: TimelineExportSubtype,
    ) -> bool:
        """
    ...
    def CreateSubtitlesFromAudio(
        self, autoCaptionSettings: Optional[AutoCaptionSettings]
    ) -> bool:
        """
    ...
    def AnalyzeDolbyVision(
        self, timelineItems: Optional[List[TimelineItem]], analysisType=None
    ) -> bool:
        """
...
class TimelineItem:
    ...
    def RenameVersionByName(
        self, oldName: str, newName: str, versionType: VersionType
    ) -> bool:
...
class Gallery:
    ...
    def SetAlbumName(
        self, galleryStillAlbum: GalleryStillAlbum, albumName: str
    ) -> bool:
...
class GalleryStillAlbum:
    ...
    def ExportStills(
        self,
        galleryStills: List[GalleryStill],
        folderPath: str,
        filePrefix: str,
        format: GalleryStillExportFormat,
    ) -> bool:
        """
...
def scriptapp(app_name: str) -> Resolve: ...
